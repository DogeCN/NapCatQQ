...
import { PacketMsgVideoElement } from '@/napcat-core/packet/message/element';
        ...
        uploadInfo: [
          {
            fileInfo: {
              ...
              type: {
                type: 2,
                picFormat: 0,
                videoFormat: video.fileFormat,
                voiceFormat: 0,
              },
              height: video.fileHeight ?? 0,
              width: video.fileWidth ?? 0,
              time: video.fileTime,
              original: 0,
            },
            subFileType: 0,
            ...
            fileInfo: {
              ...
              fileName: `${video.thumbMd5 || 'video-thumb'}.jpg`,
              type: {
                type: 1,
                picFormat: 0,
                videoFormat: 0,
