...
export const BugIcon2 = (props: IconSvgProps) => (
  ...
  >
    ...
    <g id='SVGRepo_iconCarrier'>
      <g fill='#3e4347'>
        <path d='M52.4 57.6c-1.5-1.5-.9-3.4.1-4.4c1-1 2.9-1.6 4.4-.1c1.5 1.5 2.1 4.5 1 5.5c-1 1.1-4 .5-5.5-1' />
        <path d='M55.9 43.4c-1.5-1.5-.9-3.4.1-4.4c1-1 2.9-1.6 4.4-.1c1.5 1.5 2.1 4.5 1 5.6c-1 1-4 .4-5.5-1.1' />
      </g>
      <path
      ...
      <path
        ...
        fill='#94d82a'
      />
      <path d='M30.8 57.6c-17.1 0-16.4-20 0-20v20' fill='#5b7f32' />
      <path
        d='M42.4 45.5c0 11.1-6.5 12.1-11.6 12.1c-14.1 0-14.1-20 0-20c5 0 11.6 2.4 11.6 7.9'
        fill='#94d82a'
      />
      <path d='M44.7 57.6c-21.4 0-19.4-23-1.5-23l1.5 23' fill='#5b7f32' />
      <path
      ...
      />
      <g fill='#3e4347'>
        <path d='M31.9 54.8c2.1-2.1 4.2-1.8 5.3-.7c1 1 1.4 3.2-.7 5.3c-2.1 2.1-5.8 3.3-6.9 2.3c-1.1-1.1.2-4.8 2.3-6.9' />
        <path d='M34 33.6c2.1 2.1 1.8 4.2.7 5.3c-1 1-3.2 1.4-5.3-.7s-3.3-5.8-2.3-6.8c1.1-1.1 4.8.1 6.9 2.2' />
        <path d='M20.8 55.3c1.8-1.8 3.6-1.5 4.4-.6c.9.9 1.2 2.7-.6 4.4c-1.8 1.8-4.9 2.8-5.8 1.9c-.8-.8.2-4 2-5.7' />
        <path d='M12 55.6c1.5-1.5 3-1.3 3.8-.5c.7.7 1 2.3-.5 3.8s-4.2 2.4-4.9 1.6c-.8-.7.1-3.4 1.6-4.9' />
      </g>
      <g fill='#5b7f32'>
      ...
      <g fill='#3e4347'>
        ...
        <path d='M37.6 3.4c.8.9.7 2.3-.2 3.1c-.9.8-2.3.7-3.1-.2c-.8-.9-.7-2.3.2-3.1c.9-.9 2.3-.8 3.1.2' />
        <path d='M49.2 9.8l-.1-.9c1.9-.2 3.9-2.2 4.1-4.7l.9.1c-.2 2.7-2.4 5.2-4.9 5.5' />
        <path d='M55.4 5.6c-.7 1-2.1 1.1-3.1.4c-1-.8-1.1-2.1-.4-3.1c.7-1 2.1-1.1 3.1-.4c.9.7 1.1 2.1.4 3.1' />
      </g>
      <path
    ...
    <g id='SVGRepo_iconCarrier'>
      <g>
        ...
        >
          <g style={{ filter: 'url(#Adobe_OpacityMaskFilter)' }}>
            ...
            <linearGradient
              ...
              y2='189.9944'
            >
              <stop offset='0.57' style={{ stopColor: '#F6F6F6' }} />
              <stop offset='0.6039' style={{ stopColor: '#F6F6F6' }} />
            </linearGradient>
            <polygon
        ...
        <linearGradient
          ...
          y2='189.9944'
        >
          <stop offset='0.57' style={{ stopColor: '#FFFFFF' }} />
          <stop offset='0.6039' style={{ stopColor: '#F0F0F0' }} />
        </linearGradient>
        <polygon
