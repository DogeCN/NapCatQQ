...
export const ActionName = {
  ...
  SetGroupMemberInvitePolicy: 'set_group_member_invite_policy',
  SetGroupMemberPermissions: 'set_group_member_permissions',
  SetGroupNewMemberHistoryVisibility: 'set_group_new_member_history_visibility',
