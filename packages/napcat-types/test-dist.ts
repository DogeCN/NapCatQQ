...
// 2. 测试类型 (Core)
const _coreStub = {} as NapCatCore;
const _apiStub = {} as NTQQMsgApi;
console.log('Core types access check: OK');

// 3. 测试类和类型 (OneBot)
const _obAdapterStub = {} as NapCatOneBot11Adapter;
const _obMsgStub = {} as OB11Message;
const _baseMessageEventStub = {} as OB11BaseMessageEvent;
const _baseMetaEventStub = {} as OB11BaseMetaEvent;
